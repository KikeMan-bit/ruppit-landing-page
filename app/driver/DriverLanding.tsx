...
const requirements = [
  ...
  "Vehículo en buen estado (año 2000 en adelante)",
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
          ...
          <div>
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-gray-400 text-base leading-relaxed mb-8 max-w-md">
                Sin jefes, sin horarios fijos. Acepta los viajes que quieras, cuando quieras, y cobra al finalizar cada uno.
              </p>
      ...
      <section id="como-funciona" className="py-20 sm:py-28 px-6 sm:px-10 bg-black border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <span className="text-xs font-bold uppercase tracking-widest text-[#ffc300] mb-3 block">Proceso</span>
            <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Empieza en 4 pasos</h2>
          </motion.div>

          <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-4">
            <div aria-hidden="true" className="hidden lg:block absolute top-8 h-px border-t-2 border-dashed border-[#ffc300]/20" style={{ left: "12.5%", right: "12.5%" }} />
            {steps.map((step, i) => (
              <motion.div
                key={step.number}
      ...
      <section className="py-20 sm:py-24 px-6 sm:px-10 bg-black border-t border-white/5">
        <div className="max-w-2xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            <span className="text-xs font-bold uppercase tracking-widest text-[#ffc300] mb-3 block">FAQ</span>
